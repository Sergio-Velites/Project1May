...
const pewterCity: MapType = {
  ...
  fenceDirections: {
    ...
    15: { 34: Direction.Down, 35: Direction.Down, 36: Direction.Down, 37: Direction.Down, 38: Direction.Down },
    21: { 34: Direction.Left },
    22: { 34: Direction.Left },
    23: { 34: Direction.Left },
    24: { 34: Direction.Left },
    25: { 34: Direction.Down, 35: Direction.Down, 36: Direction.Down, 37: Direction.Down, 38: Direction.Down },
  ...
  teleports: {
    35: { 0: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 1: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 2: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 3: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 4: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 5: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 6: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 7: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 8: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 9: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 10: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 11: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 18: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 19: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 26: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 27: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 28: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 29: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 30: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 31: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 32: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 33: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 34: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 35: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 36: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 37: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } }, 38: { map: MapId.Route2GateNorth, pos: { x: 5, y: 1 } } },
  },
  exits: {
