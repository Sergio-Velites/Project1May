...
import { blackBelt, cueBall, sergioNpc, martaNpc } from "../app/npcs";
  ...
  trainers: [
    {
      ...
      outtro: ["Bien… pero esto sigue sin ser CrossFit, ¿eh?"],
      money: 420,
    },
    {
      npc: cueBall,
      ...
      outtro: ["Te has ganado el gatorade. No el de los buenos."],
      money: 440,
    },
    {
      npc: sergioNpc,
      ...
      postGame: {
        message: [
          "¡Toma la MEDALLA CELESTE!",
          "Te la has currado más que muchos con dorsal.",
        ],
        items: [ItemType.CascadeBadge, ItemType.Tm34],
      },
    },
    {
      npc: martaNpc,
