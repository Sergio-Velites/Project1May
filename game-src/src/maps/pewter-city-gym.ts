import { blaine, brock, erica, giovanni, koga, ltSurge, martaNpc, misty, sabrina, sergioNpc } from "../app/npcs";
...
trainers: [
  ...
  {
    npc: ltSurge,
    pokemon: [{ id: 100, level: 18 }, { id: 26, level: 20 }],
    facing: Direction.Right,
    pos: { x: 3, y: 7 },
    intro: [
      "¡EH, RECLUTA!",
  ...
  {
    npc: sergioNpc,
    pokemon: [{ id: 59, level: 28 }, { id: 94, level: 28 }, { id: 57, level: 29 }, { id: 127, level: 30 }, { id: 131, level: 30 }, { id: 149, level: 31 }],
  ...
  {
    npc: martaNpc,
    pokemon: [{ id: 12, level: 28 }, { id: 36, level: 30 }, { id: 18, level: 30 }, { id: 42, level: 30 }, { id: 55, level: 30 }, { id: 52, level: 40 }],
    facing: Direction.Down,
    pos: { x: 5, y: 1 },
    intro: [
      "¡Yo soy MARTA!",
  ...
  teleports: {
    14: {
      ...
      5: { map: MapId.PewterCity, pos: { x: 16, y: 18 } },
    },
  },
};
