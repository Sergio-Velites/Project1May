...
import houseA1f from "./pallet-town-house-a-1f";
import houseA2f from "./pallet-town-house-a-2f";
...
import viridianCityAcadamy from "./viridian-city-pokemon-acadamy";
...
import pewterMuseum1f from "./pewter-city-museum-1f";
import pewterMuseum2f from "./pewter-city-museum-2f";
