 ...
 *
 * Dos tipos:
 *  · GLOBAL: solo un jugador se la lleva (el top de la categoría).
 *  · MILESTONE: cualquiera que cumpla la condición la recibe.
 *
 * Cada medalla tiene emoji, label (nombre corto visible en la medalla)
 * y description (tooltip al hacer hover).
 */
